if (game:GetService("CoreGui")):FindFirstChild("NightSlayer") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
	(game:GetService("CoreGui")).NightSlayer:Destroy();
	(game:GetService("CoreGui")).ScreenGui:Destroy();
end;

-- Màu sắc chủ đề Night Slayer
_G.Primary = Color3.fromRGB(0, 150, 255);    -- Xanh dương sáng
_G.Dark = Color3.fromRGB(15, 15, 25);        -- Nền tối
_G.Third = Color3.fromRGB(255, 50, 50);      -- Đỏ nhấn
_G.Accent = Color3.fromRGB(0, 200, 255);     -- Xanh neon
...
ScreenGui.Name = "NightSlayerButton";
...
OutlineButton.BackgroundTransparency = 0.3;
...
ImageButton.ImageColor3 = _G.Accent;
ImageButton.ImageTransparency = 0;
ImageButton.BackgroundTransparency = 0.5;
ImageButton.Image = "rbxassetid://7072725342"; -- Icon sword/moon
ImageButton.AutoButtonColor = false;
MakeDraggable(ImageButton, OutlineButton);
CreateRounded(ImageButton, 10);

ImageButton.MouseButton1Click:connect(function()
	if game.CoreGui:FindFirstChild("NightSlayer") then
		(game.CoreGui:FindFirstChild("NightSlayer")).Enabled = not (game.CoreGui:FindFirstChild("NightSlayer")).Enabled;
	end;
end);
...
function Update:Notify(desc)
	...
	OutlineFrame.BackgroundColor3 = Color3.fromRGB(20, 20, 30);
	...
	Image.Image = "rbxassetid://7072725342"; -- Icon sword/moon
	...
	Title.Text = "Night Slayer";
	Title.TextColor3 = _G.Accent;
	Title.TextSize = 16;
...
function Update:StartLoad()
	...
	LoaderFrame.BackgroundColor3 = Color3.fromRGB(5, 5, 10);
	...
	MainLoaderFrame.BackgroundColor3 = Color3.fromRGB(5, 5, 10);
	...
	TitleLoader.Text = "NIGHT SLAYER";
	TitleLoader.Font = Enum.Font.FredokaOne;
	TitleLoader.TextSize = 50;
	TitleLoader.TextColor3 = _G.Accent;
	...
	LoadingBarBackground.BackgroundColor3 = Color3.fromRGB(30, 30, 45);
	...
	LoadingBar.BackgroundColor3 = _G.Accent;
...
(getgenv()).LoadConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("NightSlayer") then
			makefolder("NightSlayer");
		end;
		if not isfolder("NightSlayer/Library/") then
			makefolder("NightSlayer/Library/");
		end;
		if not isfile(("NightSlayer/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("NightSlayer/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(SettingsLib));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("NightSlayer/Library/" .. game.Players.LocalPlayer.Name .. ".json"));
			for i, v in pairs(Decode) do
				SettingsLib[i] = v;
			end;
		end;
		print("Night Slayer Library Loaded!");
	else
...
(getgenv()).SaveConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfile(("NightSlayer/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("NightSlayer/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
		end;
	else
		return warn("Status : Undetected Executor");
	end;
...
function Update:Window(Config)
	...
	local NightSlayer = Instance.new("ScreenGui");
	NightSlayer.Name = "NightSlayer";
	NightSlayer.Parent = game.CoreGui;
	NightSlayer.DisplayOrder = 999;
	
	local OutlineMain = Instance.new("Frame");
	OutlineMain.Name = "OutlineMain";
	OutlineMain.Parent = NightSlayer;
	OutlineMain.ClipsDescendants = true;
	OutlineMain.AnchorPoint = Vector2.new(0.5, 0.5);
	OutlineMain.BackgroundColor3 = Color3.fromRGB(20, 20, 35);
	...
	Top.Name = "Top";
	Top.Parent = Main;
	Top.BackgroundColor3 = Color3.fromRGB(10, 10, 20);
	...
	NameHub.Text = "NIGHT SLAYER";
	NameHub.TextSize = 20;
	NameHub.TextColor3 = _G.Accent;
	...
	CloseButton.Image = "rbxassetid://10734950020"; -- Close icon
	CloseButton.ImageTransparency = 0;
	CloseButton.ImageColor3 = _G.Accent;
	CreateRounded(CloseButton, 3);
	
	CloseButton.MouseButton1Click:connect(function()
		NightSlayer.Enabled = not NightSlayer.Enabled;
	end);
	...
	ResizeButton.Image = "rbxassetid://10734886735"; -- Resize icon
	ResizeButton.ImageTransparency = 0;
	ResizeButton.ImageColor3 = _G.Accent;
	...
	BackgroundSettings.BackgroundColor3 = Color3.fromRGB(10, 10, 15);
	...
	CloseSettings.Image = "rbxassetid://10747384394"; -- Close icon
	CloseSettings.ImageTransparency = 0;
	CloseSettings.ImageColor3 = _G.Accent;
	...
	SettingsButton.Image = "rbxassetid://10734950020"; -- Settings icon
	SettingsButton.ImageTransparency = 0;
	SettingsButton.ImageColor3 = _G.Accent;
	...
	TitleSettings.Text = "Night Slayer Settings";
	TitleSettings.TextSize = 20;
	TitleSettings.TextColor3 = _G.Accent;
	...
	ScrollSettings.BackgroundColor3 = Color3.fromRGB(10, 10, 20);
	...
	function CreateCheckbox(title, state, callback)
		...
		Checkbox.BackgroundColor3 = Color3.fromRGB(100, 100, 120);
		...
		Checkbox.MouseButton1Click:Connect(function()
			...
			if checked then
				...
				Checkbox.BackgroundColor3 = _G.Accent;
			else
				Checkbox.ImageTransparency = 1;
				Checkbox.BackgroundColor3 = Color3.fromRGB(100, 100, 120);
			end;
	...
	CreateButton("Reset Config", function()
		if isfolder("NightSlayer") then
			delfolder("NightSlayer");
		end;
	...
	ScrollTab.BackgroundColor3 = Color3.fromRGB(10, 10, 20);
	...
	function uitab:Tab(text, img)
		...
		SelectedTab.BackgroundColor3 = _G.Accent;
		...
		IDK.Image = img or "rbxassetid://7072725342";
		...
		function main:Button(text, callback)
			...
			ImageLabel.ImageColor3 = _G.Accent;
			
			CreateRounded(TextButton, 4);
			
			TextButton.Name = "TextButton";
			TextButton.Parent = Button;
			TextButton.BackgroundColor3 = _G.Accent;
			...
			ArrowRight.ImageColor3 = _G.Accent;
		...
		function main:Toggle(text, config, desc, callback)
			...
			ToggleImage.BackgroundColor3 = Color3.fromRGB(60, 60, 80);
		...
		function main:Dropdown(text, option, var, callback)
			...
			SelectItems.BackgroundColor3 = Color3.fromRGB(30, 30, 40);
			...
			for i, v in next, option do
				...
				SelectedItems.BackgroundColor3 = _G.Accent;
		...
		function main:Slider(text, min, max, set, callback)
			...
			bar1.Name = "bar1";
			bar1.Parent = bar;
			bar1.BackgroundColor3 = _G.Accent;
		...
		function main:Textbox(text, disappear, callback)
			...
			RealTextbox.BackgroundColor3 = Color3.fromRGB(40, 40, 60);
		...
		function main:Line()
			...
			UIGradient.Color = ColorSequence.new({
				...
				ColorSequenceKeypoint.new(0.4, _G.Accent),
